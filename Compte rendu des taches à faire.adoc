...
** Pourle contexte, proposition de Nicolas de passer par le contexte politique . En effet, à Berlin, une cantine végane a ete mise en place et est fonctionnelle et on se demane en France si ce modele ausi peut voir le jour (avec un article à l'appui pour aider à la formulation)

** La mesure de openess des utilisateurs sera mésurée via u questionnaire de 2 questions en moyenne (NIcolas envoides references qui parlent de l'évaluation de openess)

** J'ai propose de revoir les 1h30in mis pour la durée de l'expérimentation. Car en effet, ce temps n'attire pas les utilisateurs (car vraiment trop lon et risque meme de les faire fuir), et aussi car une telle expérience au dela d'un certain temps (45 min) ne requiert plus assez de concentration venant de lutilisateur et répondra de facon agacée ( ce qui pourra biaiser nos resultats).

** Aprés analyse, nous avons décider de passer à 45 min et aprés ample reflexion, nous avons jugé de ne plus mettre le temps
...
Les questionnaies socio-démographique, les questionnaires sur 'évaluation dde hopeness et ceux mesurant le jugement délibér seront posées en alternat avec es vidéos visionnées (chaque 2 vidéos en moyenne).
