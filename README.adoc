...
- https://github.com/Yasmine07/D-lib-jugdment/blob/master/Resume%20references%20jugement%20delibere.adoc[Résumé de references sur le jugement delibere]  https://github.com/Yasmine07/D-lib-jugdment/blob/master/R%C3%A9sum%C3%A9flyer.adoc[et du livre sur l'influence des médias sur le comportement alimentaire]
